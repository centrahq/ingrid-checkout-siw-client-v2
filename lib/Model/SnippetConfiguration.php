 ...
 */
class SnippetConfiguration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SnippetConfiguration';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('loader_id', $data ?? [], null);
    ...
    */
     ...
     * Sets loader_id
     *
     * @param string|null $loader_id loader_id
     *
     * @return self
     */
    public function setLoaderId($loader_id)
    {
        ...
        if (is_null($loader_id)) {
            throw new \InvalidArgumentException('non-nullable loader_id cannot be null');
        }
