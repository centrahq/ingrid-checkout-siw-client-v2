...
class Route implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('shipping_legs', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets shipping_legs
     *
     * @param \OpenAPI\Client\Model\ShippingLeg[]|null $shipping_legs ShippingLegs represent a list of delivery steps.
     *
     * @return self
     */
    public function setShippingLegs($shipping_legs)
    {
        ...
        if (is_null($shipping_legs)) {
            throw new \InvalidArgumentException('non-nullable shipping_legs cannot be null');
        }
