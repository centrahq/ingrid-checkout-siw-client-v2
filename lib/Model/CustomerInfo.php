...
class CustomerInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets email
     *
     * @param string|null $email Customer's email where notifications will be sent to.
     *
     * @return self
     */
     ...
     *
     * @param string|null $national_identification_number Customer's national identification number, eg. SSN.
     *
     * @return self
     */
     ...
     * Sets phone
     *
     * @param string|null $phone Customer's mobile phone number where SMS notifications will be sent.
     *
     * @return self
     */
